...
```{settings and packages message=FALSE, echo=FALSE}
options(scipen=999)
library("plyr")
library("rvest")
library("ggplot2")
...
```{scraping message=FALSE, eval=FALSE, echo=FALSE}
...
```{data cleaning message=FALSE, eval=FALSE, echo=FALSE}
...
**Wikipedia**
```{wikipedia, message=FALSE, echo=FALSE}
...
```{maps backend eval=FALSE, echo=FALSE}
